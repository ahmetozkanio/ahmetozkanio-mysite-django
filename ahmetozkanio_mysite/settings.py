"""
Django settings for ahmetozkanio_mysite project.
...
SECRET_KEY = 'django-insecure-wwr8-rfhoah%y#1ijjhjsw!c-ja_%^d)=#sh7&e$aup^d$bgn8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['ahmetozkanio.herokuapp.com','127.0.0.1','192.168.1.34']
...
ROOT_URLCONF = 'ahmetozkanio_mysite.urls'
